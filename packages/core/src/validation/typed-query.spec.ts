...
describe('typed-query', () => {
  ...
  describe('test single', () => {
    ...
    it('should reject missing required query param', async () => {
      await request(app.getHttpServer()).get('/typed-query/single').query({ page: 42 }).expect(400)
    })
  ...
  describe('test array', () => {
    ...
    it('should reject missing required array', async () => {
      await request(app.getHttpServer()).get('/typed-query/array').expect(400)
    })
  })
  ...
  describe('test object', () => {
    ...
    it('should reject invalid search query', async () => {
      ...
      await request(app.getHttpServer()).get('/typed-query/object').query(query).expect(400)
    })
  })
