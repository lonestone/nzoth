...
describe('typed-route', () => {
  ...
  describe('test GET endpoints', () => {
    ...
    it('should return array of public users', async () => {
      const response = await request(app.getHttpServer()).get('/typed-route/array').expect(200)
  ...
  describe('test POST endpoints', () => {
    it('should accept valid create response', async () => {
      const response = await request(app.getHttpServer()).post('/typed-route/create').expect(201)
  ...
  describe('test PATCH endpoints', () => {
    it('should accept valid update response', async () => {
      const response = await request(app.getHttpServer()).patch('/typed-route/update').expect(200)
  ...
  describe('test DELETE endpoints', () => {
    it('should accept valid delete response', async () => {
      const response = await request(app.getHttpServer()).delete('/typed-route/delete').expect(200)
